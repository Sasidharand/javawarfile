...
.tabcontent {
  ...
  <script> alert("tab boolean 1 value = "+<%=activatetab %> ); </script>
	...
	function tabvalue(prodidval){
		
		window.location.replace("template4.jsp?prodidname="+prodidval);
		
	alert("inside tabvalue " + prodidval);
//	prodidval="2593215";
		...
		String prodidname =request.getParameter("prodidname");
		...
		try {
			...
			extendedspecdetails=stmt2.executeQuery("SELECT e. prodid,v.text   AS Sector,v2.text  AS Header,v3.text  AS Body "+
					" FROM   cds_especee e "+
					" JOIN cds_evocee  v "+
					" ON e .sectid = v .id "+
					" JOIN cds_evocee  v2 "+
			...
			extendedspeccompinfo=stmt2.executeQuery("SELECT e. prodid,v.text   AS Sector,v2.text  AS Header,v3.text  AS Body "+
					" FROM   cds_especee e "+
					" JOIN cds_evocee  v "+
					" ON e .sectid = v .id "+
					" JOIN cds_evocee  v2 "+
